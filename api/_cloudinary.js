...
export async function fetchCloudinaryFolder({ folder, thumbTransform = "w_500,h_500,c_fill,g_auto,f_auto,q_auto" }) {
  ...
  // ครอบคลุมทั้งรูปที่อยู่ตรงในโฟลเดอร์ และรูปในโฟลเดอร์ย่อย รวมถึงบัญชีรุ่นเก่าที่ยังใช้ระบบ
  // โฟลเดอร์แบบเดิม (เก็บ path ไว้ใน public_id) — asset_folder เพียวไม่ครอบคลุมทั้งสองแบบ
