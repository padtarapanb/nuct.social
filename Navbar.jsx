...
function SocialCard({ item, index }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`reveal reveal-delay-${index + 1} card p-7 flex flex-col justify-between group`}
    >
      <div>
        <div
          className="w-14 h-14 rounded-2xl flex items-center justify-center text-white mb-6 transition-transform duration-500 group-hover:scale-110"
      ...
      <div className="mt-6 flex items-center gap-1.5 text-sm font-semibold text-pine-800">
