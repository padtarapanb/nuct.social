...
const FIELDS = [
  ...
  },
  {
    ...
    label:
      "ลิงก์ฝัง Google Maps สำหรับ Contact (เปิด Google Maps > ค้นหาสถานที่ > แชร์ > ฝังแผนที่ > คัดลอก HTML > เอามาแค่ URL ที่อยู่ใน src=\"...\" เท่านั้น ต้องขึ้นต้นด้วย https://www.google.com/maps/embed หรือ https://www.google.com/maps?...&output=embed ก็ได้)",
