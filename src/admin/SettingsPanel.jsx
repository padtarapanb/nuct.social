...
const FIELDS = [
  ...
  },
  {
    ...
    label:
      "ลิงก์ Google Maps สำหรับ Contact (วางลิงก์แชร์ปกติจาก Google Maps ได้เลย เช่น ลิงก์ที่ได้จากการกดแชร์สถานที่ > คัดลอกลิงก์ หรือจะใช้ลิงก์แบบฝัง (Embed a map > คัดลอก HTML > เอาเฉพาะ URL ใน src=\"...\") ก็ได้เหมือนกัน)",
