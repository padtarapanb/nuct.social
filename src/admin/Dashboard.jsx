      ...
      case "aboutImages":
        return (
          <ListEditor
            ...
            description="รูปที่ 'เปิดใช้งาน' จะแสดงในสไลด์ฝั่งซ้ายของ About เลื่อนอัตโนมัติทุก 5 วินาที เรียงลำดับด้วยปุ่มลูกศร"
            fields={[
              { name: "image_url", label: "ลิงก์รูปภาพ (URL)", placeholder: "https://...", wide: true },
      ...
      case "historyImages":
        return (
          <ListEditor
            ...
            description="รูปที่ 'เปิดใช้งาน' จะแสดงในสไลด์ของส่วนประวัติชมรม เลื่อนอัตโนมัติทุก 5 วินาที เรียงลำดับด้วยปุ่มลูกศร"
            fields={[
              { name: "image_url", label: "ลิงก์รูปภาพ (URL)", placeholder: "https://...", wide: true },
              { name: "is_active", label: "เปิดใช้งาน (แสดงในสไลด์)", type: "checkbox", default: true },
            ]}
      ...
      case "galleryCategories":
        return (
          <ListEditor
            ...
            title="แกลเลอรี"
            description="ใส่ลิงก์รูปภาพ (URL) ที่ขึ้นต้นด้วย http:// หรือ https:// เพื่อให้ขึ้นรูปจริง ถ้าเว้นว่างจะเป็นการ์ดสีไล่เฉดแทน"
            fields={[
              { name: "key", label: "รหัสหมวด (ภาษาอังกฤษ ไม่ซ้ำ)", placeholder: "camp" },
              { name: "title", label: "ชื่อหมวด", placeholder: "Camp" },
              { name: "image", label: "ลิงก์รูปภาพ", placeholder: "https://...", wide: true },
            ]}
          />
        );
      case "team":
          ...
          <div>
            ...
            {teamTab === "committee" ? (
              <ListEditor
                ...
                description="ใส่ลิงก์รูปภาพ (URL) เพื่อให้ขึ้นรูปจริงแทนตัวอักษรย่อ แสดงทั้งในหน้า Team และแท็บ Committee ของ Leadership popup"
                fields={[
                  { name: "role", label: "ตำแหน่ง", placeholder: "President" },
                  { name: "name", label: "ชื่อ-นามสกุล", placeholder: "ชื่อ นามสกุล" },
                  { name: "photo", label: "ลิงก์รูปภาพ", placeholder: "https://..." },
