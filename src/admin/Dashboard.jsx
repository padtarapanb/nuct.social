            ...
            {teamTab === "committee" ? (
              <ListEditor
                ...
                fields={[
                  {
                    name: "group_name",
                    label: "แท็บที่จะให้แสดง",
                    type: "select",
                    options: [
                      { value: "committee", label: "Committee (คณะกรรมการ)" },
                      { value: "pr", label: "ประชาสัมพันธ์ (PR Team)" },
                    ],
                    default: "committee",
                  },
      ...
      case "networkPartners":
        return (
          <ListEditor
            ...
            description="คริสตจักรหรือหน่วยงานอื่นที่เกี่ยวข้อง แสดงในแท็บ \"เครือข่าย\" ใต้หัวข้อติดต่อของหน้าเว็บ"
            fields={[
              { name: "name", label: "ชื่อองค์กร/คริสตจักร", placeholder: "คริสตจักร..." },
              { name: "description", label: "คำอธิบายสั้น ๆ", type: "textarea", wide: true },
              { name: "link", label: "ลิงก์ (เว็บไซต์ / Facebook)", placeholder: "https://..." },
