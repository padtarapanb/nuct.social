...
const ICONS = { instagram: Camera, facebook: Users, music2: Music2, x: XIcon, line: MessageCircle };
        ...
        return (
          ...
          >
            <div className="flex items-center gap-2.5">
              {isDisplayableImageUrl(p.logo_url) && (
                <img
            ...
            {p.description && (
              <p
                className="text-white/70 text-xs leading-relaxed rich-text"
                dangerouslySetInnerHTML={renderText(p.description)}
              />
            )}
