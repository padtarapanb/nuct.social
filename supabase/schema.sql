...
declare
  t text;
begin
  foreach t in array array['activities','upcoming_events','socials','gallery_categories','gallery_albums','team_members','testimonials','faqs','about_images','history_images','shepherding_groups','site_settings','network_partners','pr_tasks','achievements']
  loop
