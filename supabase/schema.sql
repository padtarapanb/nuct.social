...
insert into team_members (role, name, photo, ig, fb, sort_order) values
  ('President', 'ชื่อ นามสกุล', '', '#', '#', 0),
  ('Vice President', 'ชื่อ นามสกุล', '', '#', '#', 1),
  ('PR Team', 'ชื่อ นามสกุล', '', '#', '#', 2),
  ('Media Team', 'ชื่อ นามสกุล', '', '#', '#', 3),
  ('Worship Team', 'ชื่อ นามสกุล', '', '#', '#', 4)
on conflict do nothing;
